...
type ProductServiceClient interface {
	...
	UpdateProductStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*ProductResponse, error)
}
...
func (c *productServiceClient) UpdateProductStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
	out := new(ProductResponse)
	err := c.cc.Invoke(ctx, "/product.ProductService/UpdateProductStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	UpdateProductStock(context.Context, *UpdateStockRequest) (*ProductResponse, error)
...
func (UnimplementedProductServiceServer) UpdateProductStock(context.Context, *UpdateStockRequest) (*ProductResponse, error) {
...
func _ProductService_UpdateProductStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.ProductService/UpdateProductStock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
